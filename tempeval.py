...
def main(argList):
    ...
    global consider_DURING_as_SIMULTANEOUS
...
def final_score(): 
	...
	print global_prec_matched, global_rec_matched, global_system_total, global_gold_total, evaluation_method
...
def input_and_evaluate():
	...
	if len(args) < 3: 
		...
		directory_path = get_directory_path(args[0])
