...
classifierList = glob.glob(classDir+"*")                # Change input parameter if you want to use different directories
clList = []
...
#    print cl
    if os.path.isdir(cl):
        clList.append(cl)
if len(clList) == 0:
    print "No directories starting with ", classDir
    exit()
